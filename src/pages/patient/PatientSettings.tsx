...
function ProfileSection() {
  ...
  useEffect(() => {
    ...
    setForm({
      ...
      phone: account.phone ?? '',
      landline: account.landline ?? p.landline ?? '',
      date_of_birth: account.date_of_birth ?? p.date_of_birth ?? '',
      gender: account.gender ?? p.gender ?? '',
      is_foreign: account.is_foreign ?? p.is_foreign ?? false,
      cpf: account.cpf ?? '',
      rg: account.rg ?? p.rg ?? '',
      profession: account.profession ?? p.profession ?? '',
      notes: account.notes ?? p.notes ?? '',
      photo_url: account.photo_url ?? profile?.avatar_url ?? p.photo_url ?? '',
      sms_reminders: account.sms_reminders ?? p.sms_reminders ?? true,
      emergency_contact_name: account.emergency_contact_name ?? p.emergency_contact_name ?? '',
      emergency_contact_phone: account.emergency_contact_phone ?? p.emergency_contact_phone ?? '',
      zip_code: account.zip_code ?? p.zip_code ?? '',
      address: account.address ?? p.address ?? '',
      address_complement: account.address_complement ?? p.address_complement ?? '',
      neighborhood: account.neighborhood ?? p.neighborhood ?? '',
      city: account.city ?? p.city ?? '',
      state: account.state ?? p.state ?? '',
      guardian_name: account.guardian_name ?? p.guardian_name ?? '',
      guardian_cpf: account.guardian_cpf ?? p.guardian_cpf ?? '',
      guardian_date_of_birth: account.guardian_date_of_birth ?? p.guardian_date_of_birth ?? '',
      insurance_provider: account.insurance_provider ?? p.insurance_provider ?? '',
      insurance_holder: account.insurance_holder ?? p.insurance_holder ?? '',
      insurance_number: account.insurance_number ?? p.insurance_number ?? '',
      insurance_holder_cpf: account.insurance_holder_cpf ?? p.insurance_holder_cpf ?? '',
    });
